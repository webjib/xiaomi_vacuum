...
ATTR_MAIN_BRUSH_LIFE_LEVEL: Final = "main_brush_life_level"
ATTR_SIDE_BRUSH_LEFT_TIME: Final = "side_brush_time_left"
ATTR_SIDE_BRUSH_LIFE_LEVEL: Final = "side_brush_life_level"
ATTR_FILTER_LIFE_LEVEL: Final = "filter_life_level"
